...
<table border="1">
    ...
    <tbody>
        ...
        try {
            $insert_itxviewmemo = "INSERT INTO nowprd.itxview_leadtime(
                                                                                ORDERDATE,
                                                                                PELANGGAN,
                                                                                BUYER,
                                                                                NO_ITEM,
            ...
            $stmt = $pdo->prepare($insert_itxviewmemo);
        ...
        while ($rowdb2 = sqlsrv_fetch_array($stmt)) {
            ...
            $q_posisikk = db2_exec($conn1, "SELECT DISTINCT
                                                        ...
                                                        VARCHAR_FORMAT(iptip.MULAI, 'YYYY-MM-DD HH24:MI:SS') AS MULAI,
                                                        VARCHAR_FORMAT(iptop.SELESAI, 'YYYY-MM-DD HH24:MI:SS') AS SELESAI
                                                    FROM 
                                                        PRODUCTIONDEMANDSTEP p 
                                                    LEFT JOIN ITXVIEW_POSISIKK_TGL_IN_PRODORDER iptip ON iptip.PRODUCTIONORDERCODE = p.PRODUCTIONORDERCODE AND iptip.DEMANDSTEPSTEPNUMBER = p.STEPNUMBER
                                                    LEFT JOIN ITXVIEW_POSISIKK_TGL_OUT_PRODORDER iptop ON iptop.PRODUCTIONORDERCODE = p.PRODUCTIONORDERCODE AND iptop.DEMANDSTEPSTEPNUMBER = p.STEPNUMBER
                                                    WHERE
                                                        p.PRODUCTIONORDERCODE  = '00157531' 
                                                        -- p.PRODUCTIONORDERCODE  = '$rowdb2[NO_KK]' 
            ...
            if ($row_posisikk_dye2_1['mulai'] == '1900-01-01 00:00:00.000') {
                ...
                $waktuawal_dye2 = $row_posisikk_dye2_1['mulai'];
            ...
            if ($row_posisikk_dye4_1['mulai'] == '1900-01-01 00:00:00.000') {
                ...
                $waktuawal_dye4 = $row_posisikk_dye4_1['mulai'];
            ...
            if ($row_posisikk_opw1_1['mulai'] == '1900-01-01 00:00:00.000') {
                ...
                $waktuawal_opw1 = $row_posisikk_opw1_1['mulai'];
                $waktuakhir_opw1 = $row_posisikk_opw1_2['selesai'];
            }
            ...
            if ($row_posisikk_ovd1_1['mulai'] == '1900-01-01 00:00:00.000') {
                ...
                $waktuawal_ovd1 = $row_posisikk_ovd1_1['mulai'];
            ...
            if ($row_posisikk_ovn1_1['mulai'] == '1900-01-01 00:00:00.000') {
                ...
                $waktuawal_ovn1 = $row_posisikk_ovn1_1['mulai'];
            ...
            if ($row_posisikk_ovn2_1['mulai'] == '1900-01-01 00:00:00.000') {
                ...
                $waktuawal_ovn2 = $row_posisikk_ovn2_1['mulai'];
            ...
            if ($row_posisikk_fnj1_1['mulai'] == '1900-01-01 00:00:00.000') {
                ...
                $waktuawal_fnj1 = $row_posisikk_fnj1_1['mulai'];
            ...
            if ($row_posisikk_gkj1_1['mulai'] == '1900-01-01 00:00:00.000') {
                ...
                $waktuawal_gkj1 = $row_posisikk_gkj1_1['mulai'];
            ...
            if ($row_posisikk_ppc4_1['mulai'] == '1900-01-01 00:00:00.000') {
                ...
                $waktuawal_ppc4 = $row_posisikk_ppc4_1['mulai'];
            ...
            <tr>
                ...
                <td><a target="_BLANK"
                        href="http://online.indotaichen.com/laporan/ppc_filter_steps.php?demand=<?= $rowdb2['DEMAND']; ?>&prod_order=<?= $rowdb2['NO_KK']; ?>">
                        <?= $rowdb2['DEMAND']; ?></a></td> <!-- DEMAND -->
                <td>
                    <?php
                ...
                <td><?php echo round($diff_bat1->d + $diff_bat1->h / 24 + $diff_bat1->i / 1440, 2); ?></td>
                <!-- BAT1 BAGI KAIN -->
                <td><?php echo round($diff_bat2->d + $diff_bat2->h / 24 + $diff_bat2->i / 1440, 2); ?></td>
                <!-- BAT2 BUKA KAIN -->
                <td><?php echo round($diff_bkn1->d + $diff_bkn1->h / 24 + $diff_bkn1->i / 1440, 2); ?></td>
                <!-- BKN1 BALIK KAIN -->
                <td><?php echo round($diff_sco1->d + $diff_sco1->h / 24 + $diff_sco1->i / 1440, 2); ?></td>
                <!-- SCO1 SCOURING -->
                <td><?php echo round($diff_rlx1->d + $diff_rlx1->h / 24 + $diff_rlx1->i / 1440, 2); ?></td>
                <!-- RLX1 RELAXING -->
                <td><?php echo round($diff_cbl1->d + $diff_cbl1->h / 24 + $diff_cbl1->i / 1440, 2); ?></td>
                <!-- CBL1 CONTINOUS BLEACING -->
                <td><?php echo round($diff_mat1->d + $diff_mat1->h / 24 + $diff_mat1->i / 1440, 2); ?></td>
                <!-- MAT1 LAB COLOR MATCH -->
                <td><?php echo round($diff_pre1->d + $diff_pre1->h / 24 + $diff_pre1->i / 1440, 2); ?></td>
                <!-- PRE1 P<i class="icofont icofont-refresh"></i> Reset -->
                <td><?php echo round($diff_rse1->d + $diff_rse1->h / 24 + $diff_rse1->i / 1440, 2); ?></td>
                <!-- RSE1 RAISING GREIGE FACE -->
                <td><?php echo round($diff_rse2->d + $diff_rse2->h / 24 + $diff_rse2->i / 1440, 2); ?></td>
                <!-- RSE2 RAISING GREIGE BACK -->
                <td><?php echo round($diff_shr1->d + $diff_shr1->h / 24 + $diff_shr1->i / 1440, 2); ?></td>
                <!-- SHR1 SHEARING GREIGE FACE -->
                <td><?php echo round($diff_shr2->d + $diff_shr2->h / 24 + $diff_shr2->i / 1440, 2); ?></td>
                <!-- SHR2 SHEARING GREIGE BACK -->
                <td><?php echo round($diff_sue1->d + $diff_sue1->h / 24 + $diff_sue1->i / 1440, 2); ?></td>
                <!-- SUE1 SUEDING GREIGE FACE -->
                <td><?php echo round($diff_sue2->d + $diff_sue2->h / 24 + $diff_sue2->i / 1440, 2); ?></td>
                <!-- SUE2 SUEDING GREIGE BACK -->
                <td><?php echo round($diff_dye1->d + $diff_dye1->h / 24 + $diff_dye1->i / 1440, 2); ?></td>
                <!-- DYE1 FABRIC DYEING (WHITE/HEATER) -->
                <td><?php echo round($diff_dye2->d + $diff_dye2->h / 24 + $diff_dye2->i / 1440, 2); ?></td>
                <!-- DYE2 FABRIC DYEING (POLY) -->
                <td><?php echo round($diff_dye3->d + $diff_dye3->h / 24 + $diff_dye3->i / 1440, 2); ?></td>
                <!-- DYE3 FABRIC DYEING (CD) -->
                <td><?php echo round($diff_dye4->d + $diff_dye4->h / 24 + $diff_dye4->i / 1440, 2); ?></td>
                <!-- DYE4 FABRIC DYEING (COTTON/RAYON/TENCEL/MODAL) -->
                <td><?php echo round($diff_dye5->d + $diff_dye5->h / 24 + $diff_dye5->i / 1440, 2); ?></td>
                <!-- DYE5 FABRIC DYEING (NYLON) -->
                <td><?php echo round($diff_dye6->d + $diff_dye6->h / 24 + $diff_dye6->i / 1440, 2); ?></td>
                <!-- DYE6 FABRIC DYEING CVC+TC (POLY+COTTON) -->
                <td><?php echo round($diff_sop1->d + $diff_sop1->h / 24 + $diff_sop1->i / 1440, 2); ?></td>
                <!-- SOP1 SOAPING -->
                <td><?php echo round($diff_bld1->d + $diff_bld1->h / 24 + $diff_bld1->i / 1440, 2); ?></td>
                <!-- BLD1 BELAH DYEING -->
                <td><?php echo round($diff_blp1->d + $diff_blp1->h / 24 + $diff_blp1->i / 1440, 2); ?></td>
                <!-- BLP1 BELAH P<i class="icofont icofont-refresh"></i> Reset -->
                <td><?php echo round($diff_opw1->d + $diff_opw1->h / 24 + $diff_opw1->i / 1440, 2); ?></td>
                <!-- OPW1 BELAH CUCI -->
                <td><?php echo round($diff_ovd1->d + $diff_ovd1->h / 24 + $diff_ovd1->i / 1440, 2); ?></td>
                <!-- OVD1 OVEN DYEING -->
                <td><?php echo round($diff_ovn1->d + $diff_ovn1->h / 24 + $diff_ovn1->i / 1440, 2); ?></td>
                <!-- OVN1 OVEN STENTER -->
                <td><?php echo round($diff_ovn2->d + $diff_ovn2->h / 24 + $diff_ovn2->i / 1440, 2); ?></td>
                <!-- OVN2 OVEN KERING -->
                <td><?php echo round($diff_ovn3->d + $diff_ovn3->h / 24 + $diff_ovn3->i / 1440, 2); ?></td>
                <!-- OVN3 OVEN TAMBAH OBAT SETELAH PRT -->
                <td><?php echo round($diff_cpt1->d + $diff_cpt1->h / 24 + $diff_cpt1->i / 1440, 2); ?></td>
                <!-- CPT1 COMPACT -->
                <td><?php echo round($diff_fin1->d + $diff_fin1->h / 24 + $diff_fin1->i / 1440, 2); ?></td>
                <!-- FIN1 FINISHING 1 -->
                <td><?php echo round($diff_fnj1->d + $diff_fnj1->h / 24 + $diff_fnj1->i / 1440, 2); ?></td>
                <!-- FNJ1 FINISHING JADI 1 -->
                <td><?php echo round($diff_stm1->d + $diff_stm1->h / 24 + $diff_stm1->i / 1440, 2); ?></td>
                <!-- STM1 STEAM FINISHING -->
                <td><?php echo round($diff_stm2->d + $diff_stm2->h / 24 + $diff_stm2->i / 1440, 2); ?></td>
                <!-- STM2 STEAM PRINTING -->
                <td><?php echo round($diff_tdr1->d + $diff_tdr1->h / 24 + $diff_tdr1->i / 1440, 2); ?></td>
                <!-- TDR1 TUMBLE DRY -->
                <td><?php echo round($diff_shr3->d + $diff_shr3->h / 24 + $diff_shr3->i / 1440, 2); ?></td>
                <!-- SHR3 SHEARING FINISHED FACE -->
                <td><?php echo round($diff_shr4->d + $diff_shr4->h / 24 + $diff_shr4->i / 1440, 2); ?></td>
                <!-- SHR4 SHEARING FINISHED BACK -->
                <td><?php echo round($diff_shr5->d + $diff_shr5->h / 24 + $diff_shr5->i / 1440, 2); ?></td>
                <!-- SHR5 SHEARING FINISHED FACE AFTER PRT -->
                <td><?php echo round($diff_sue3->d + $diff_sue3->h / 24 + $diff_sue3->i / 1440, 2); ?></td>
                <!-- SUE3 SUEDING FINISHED FACE -->
                <td><?php echo round($diff_sue4->d + $diff_sue4->h / 24 + $diff_sue4->i / 1440, 2); ?></td>
                <!-- SUE4 SUEDING FINISED BACK -->
                <td><?php echo round($diff_flt1->d + $diff_flt1->h / 24 + $diff_flt1->i / 1440, 2); ?></td>
                <!-- FLT1 PRINTING FLAT -->
                <td><?php echo round($diff_ins2->d + $diff_ins2->h / 24 + $diff_ins2->i / 1440, 2); ?></td>
                <!-- INS2 INSPECTION (PRINTING) -->
                <td><?php echo round($diff_rot1->d + $diff_rot1->h / 24 + $diff_rot1->i / 1440, 2); ?></td>
                <!-- ROT1 PRINTING ROTARY -->
                <td><?php echo round($diff_spt1->d + $diff_spt1->h / 24 + $diff_spt1->i / 1440, 2); ?></td>
                <!-- SPT1 SOAPING AFTER PRINTING -->
                <td><?php echo round($diff_sub1->d + $diff_sub1->h / 24 + $diff_sub1->i / 1440, 2); ?></td>
                <!-- SUB1 PRINTING SUBLIM -->
                <td><?php echo round($diff_cur1->d + $diff_cur1->h / 24 + $diff_cur1->i / 1440, 2); ?></td>
                <!-- CUR1 CURING -->
                <td><?php echo round($diff_ins3->d + $diff_ins3->h / 24 + $diff_ins3->i / 1440, 2); ?></td>
                <!-- INS3 FINAL INSPECTION -->
                <td><?php echo round($diff_qcf4->d + $diff_qcf4->h / 24 + $diff_qcf4->i / 1440, 2); ?></td>
                <!-- QCF4 QC FINAL -->
                <td><?php echo round($diff_cnp1->d + $diff_cnp1->h / 24 + $diff_cnp1->i / 1440, 2); ?></td>
                <!-- CNP1 CUTTING + PACKING -->
                <td><?php echo round($diff_gkj1->d + $diff_gkj1->h / 24 + $diff_gkj1->i / 1440, 2); ?></td>
                <!-- GKJ1 MUTASI -->
                <td><?php echo round($diff_ppc4->d + $diff_ppc4->h / 24 + $diff_ppc4->i / 1440, 2); ?></td>
                <!-- PPC4 KK OK -->
