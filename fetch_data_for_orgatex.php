...
if (isset($_POST['production_number'])) {
    ...
    if ($dataMain) {
        ...
        $sqlDetail = "SELECT
                        ...
                        COALESCE(ITXVIEWRESEP.SUFFIXCODE, ITXVIEWRESEP.SUFFIXCODE_RESERVATION) AS SUFFIXCODE, 
                        ...
                        CASE
                            WHEN ITXVIEWRESEP.CODE = '' THEN COALESCE(TRIM(ITXVIEWRESEP2.CODE), TRIM(ITXVIEWRESEP.SUBCODE01_RESERVATION)) || '-' || COALESCE(TRIM(ITXVIEWRESEP.SUFFIXCODE), TRIM(ITXVIEWRESEP.SUFFIXCODE_RESERVATION))
                            ELSE TRIM(ITXVIEWRESEP.CODE) || '-' || COALESCE(TRIM(ITXVIEWRESEP.SUFFIXCODE), TRIM(ITXVIEWRESEP.SUFFIXCODE_RESERVATION))
                        END	AS CODE,
                        CASE
