                                    ...
                                    <div class="card-block">
                                        <form action="" method="post">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-xl-2 m-b-30">
                                                    ...
                                                    <select class="form-control" name="status_order">
                                                        <option value="0" <?php if ($_POST['status_order'] == "0") {
                                                            echo "SELECTED";
                                                        } ?>>
                                                            All</option>
                                                        <option value="1" <?php if ($_POST['status_order'] == "1") {
                                                            echo "SELECTED";
                                                        } ?>>
                                                            Close</option>
                                                    </select>
                                                ...
                                                <div class="col-sm-12 col-xl-4 m-b-30">
                                                    ...
                                                    <input type="checkbox" id="rec" name="rec" value="rec" <?php if ($_POST['rec'] == 'rec') {
                                                        echo 'checked';
                                                    } ?>>
                                                ...
                                                <div class="col-sm-12 col-xl-2 m-b-30">
                                                    ...
                                                    <input type="date" name="tgl1_kirim" class="form-control"
                                                        id="tgl1_kirim" value="<?php if (isset($_POST['submit'])) {
                                                            echo $_POST['tgl1_kirim'];
                                                        } ?>">
                                                </div>
                                                <div class="col-sm-12 col-xl-2 m-b-30">
                                                    <h4 class="sub-title">S/d Tanggal (Tgl Kirim)</h4>
                                                    <input type="date" name="tgl2_kirim" class="form-control"
                                                        id="tgl2_kirim" value="<?php if (isset($_POST['submit'])) {
                                                            echo $_POST['tgl2_kirim'];
                                                        } ?>">
                                                </div>
                                            ...
                                            <p>*Note : Jika data terasa mulai <b>lambat</b> cobalah untuk klik tombol
                                                <b><i class="icofont icofont-refresh"></i> Reset</b> untuk menghapus
                                                semua history pencarian.
                                            </p>
                                        </form>
                                    </div>
                                </div>
                                                ...
                                                <table id="tbl-excel" class="table table-striped table-bordered nowrap">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th
                                                                title="Sumber data: &#013; 1. Production Order &#013; 2. Reservation &#013; 3. KFF/KGF User Primary Quantity">
                                                                QTY SALINAN</th>
                                                            <th
                                                                title="Sumber data: &#013; 1. Production Demand &#013; 2. Bagian group Entered quantity &#013; 3. User Primary Quantity">
                                                                QTY PACKING</th>
                                                            <th
                                                                title="Sumber data: &#013; 1. Production Demand &#013; 2. Bagian group Entered quantity &#013; 3. User Secondary Quantity">
                                                                QTY PACKING YARD</th>
                                                            <th>QTY SISA</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if ($tgl1_kirim & $tgl2_kirim) {
                                                            ...
                                                            // $value_itxviewmemo = implode(',', $r_itxviewmemo);
                                                            // var_dump($value_itxviewmemo);
                                                            // var_dump(sqlsrv_errors($value_itxviewmemo));
                                                            $sql_insert_itxviewmemo = "INSERT INTO nowprd.[itxview_poselesai_test](
                                                                ORDERDATE,
                                                                    ...
                                                                    CREATEDATETIME,
                                                                    ACCESS_TO) 
                                                                    VALUES $value_itxviewmemo";

                                                            if (!$sql_insert_itxviewmemo) {
                                                            ...
                                                            // $insert_itxviewmemo = sqlsrv_prepare($con_nowprd, $sql_insert_itxviewmemo, $value_itxviewmemo);
                                                        ...
                                                        while ($rowdb2 = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                                            ...
                                                            ?>
                                                            <?php $jeniskain = $rowdb2['JENIS_KAIN'];
