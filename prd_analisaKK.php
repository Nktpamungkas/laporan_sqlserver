                                        ...
                                        <form action="" method="post">
                                            <div class="row">
                                                <div class="col-sm-6 col-xl-6 m-b-30">
                                                    ...
                                                    <select id='public-methods' multiple='multiple' name="operation[]" required>
                                                        <?php
                                                ...
                                                <div class="col-sm-6 col-xl-6 m-b-30">
                                                    ...
                                                    <select id='public-methods2' multiple='multiple' name="operation2[]" <?= !empty($_GET['demand2'])? 'required':'';?>>
                                                        <?php
                                            ...
                                            <?php else : ?>
                                                ...
                                                <table width="100%" style="border: 1px solid black; border-collapse: collapse;">
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            <th style="vertical-align: text-top;">Panjang Benang</th>
                                                            <th style="vertical-align: text-top;">:</th>
                                                            <th style="vertical-align: text-top;">
                                                                <?php
                                                                    if($value_benang){
                                                ...
                                                <?php
                                                    $q_looping1     = db2_exec($conn1, "SELECT
                                                                                        ...
                                                                                        WHERE
                                                                                           SUBSTR(a.VALUESTRING, 5, 8) = '$d_ITXVIEWKK[PRODUCTIONDEMANDCODE]'");
                                                
                                                    $data_looping1 = [];  // Step 1: Prepare an empty array

                                                    while ($row = db2_fetch_assoc($q_looping1)) {
                                                        $data_looping1[] = $row;  // Step 2: Push each row into array
                                                    }
                                                   
                                                ?>
                                                <?php foreach  ($data_looping1 as $row_looping1) : ?>
                                                    <?php
                                                        require_once "koneksi.php";
                                                    ...
                                                    <?php
                                                        $q_looping2     = db2_exec($conn1, "SELECT
                                                                                            ...
                                                                                            LEFT JOIN ADSTORAGE a ON a.UNIQUEID = p.ABSUNIQUEID AND a.FIELDNAME = 'OriginalPDCode'
                                                                                            WHERE
                                                                                               SUBSTR(a.VALUESTRING, 5, 8) = '$row_looping1[PRODUCTIONDEMANDCODE]'");
                                                    ?>
                                                    <?php while ($row_looping2 = db2_fetch_assoc($q_looping2)) : ?>
                                                        <?php if ($row_looping2['PRODUCTIONDEMANDCODE']) : ?>
                                                            ...
                                                            <center style="background-color: #e67e22; color: white;">
                                                                <i class="ti-angle-double-down"></i>
                                                                 <strong>Salinan dari demand <?= substr($d_ITXVIEWKK['ORIGINALPDCODE'], 4, 8); ?>
                                                                <i class="ti-angle-double-down"></i>
                                                            </center>
                                                            <table width="100%" style="border: 1px solid black; border-collapse: collapse;">
                                                                <thead>
                                                ...
                                                <?php if (!empty($_POST['demand2'])) : ?>
                                                    <div class="col-sm-6" style="border-left: 6px solid green; height: 100%;">
                                                        ...
                                                        $data_looping1_bd2 = [];  // Step 1: Prepare an empty array

                                                        while ($row = db2_fetch_assoc($q_looping1_bd2)) {
                                                            $data_looping1_bd2[] = $row;  // Step 2: Push each row into array
                                                        }
                                                        
                                                        ?>
                                                        <?php foreach ($data_looping1_bd2 as $row_looping1_bd2) : ?>
                                                            <?php
                                                                require_once "koneksi.php";
