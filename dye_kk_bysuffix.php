                                        ...
                                        <form action="" method="post">
                                            <div class="row">
                                                <div class="col-sm-12 col-xl-6 m-b-30">
                                                    ...
                                                    <input type="text" class="form-control" name="subcode01"
                                                        value="<?php if (isset($_POST['submit'])){ echo $_POST['subcode01']; } ?>">
                                                </div>
                                                <div class="col-sm-12 col-xl-6 m-b-30">
                                                    <h4 class="sub-title">SUFFIX CODE:</h4>
                                                    <input type="text" class="form-control" name="suffix"
                                                        value="<?php if (isset($_POST['submit'])){ echo $_POST['suffix']; } ?>">
                                                </div>
                                            ...
                                            <table id="basic-btn"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a target="_BLANK"
                                                                href="http://10.0.0.10/laporan/ppc_filter_steps.php?demand=<?= $row_prod['DEAMAND']; ?>"><?= $row_prod['DEAMAND']; ?></a>
                                                        </td>
                                                        ...
                                                        <?php
                                                            ...
                                                            ?>
                                                        <td><?= $d_StatusTerakhir['LONGDESCRIPTION']; ?></td>
                                                        <!--  STATUS TERAKHIR  -->
