...
SELECT
	...
	CASE
		WHEN RECIPE.RECIPETYPE = '1' THEN ((RECIPE.PICKUPPERCENTAGE/100 * $STRINGLUAPA['WEIGHT']) + RECIPE.RESIDUALBATHVOLUME * ITXVIEWRESEP1.CONSUMPTION) / 1000
		ELSE
			CASE
				WHEN ITXVIEWRESEP1.CONSUMPTIONTYPE = '1' THEN (($STRINGLUAPA['WEIGHT'] * $STRINGLUAPA['LIQUORATIO']) * ITXVIEWRESEP1.CONSUMPTION ) / 1000
				WHEN ITXVIEWRESEP1.CONSUMPTIONTYPE = '2' THEN ($STRINGLUAPA['WEIGHT'] * ITXVIEWRESEP1.CONSUMPTION/100) * 1000
			END
	END AS QTY	   
FROM
	RECIPE RECIPE
