...
SELECT
    ...
    CASE
		WHEN ITXVIEWRESEP.RECIPETYPE = '1' THEN CAST( ((ITXVIEWRESEP.PICKUPPERCENTAGE/100 * $STRING_LU_APA['WEIGHT']) + ITXVIEWRESEP.RESIDUALBATHVOLUME) * ITXVIEWRESEP2.CONSUMPTION AS DECIMAL(18, 4))
		ELSE 
			CASE
				WHEN ITXVIEWRESEP2.CONSUMPTIONTYPE = '1' THEN CAST( (($STRING_LU_APA['WEIGHT'] * VIEWPRODUCTIONRESERVATION.PICKUPQUANTITY) * ITXVIEWRESEP2.CONSUMPTION) / 1000 AS DECIMAL(18, 4))
				WHEN ITXVIEWRESEP2.CONSUMPTIONTYPE = '2' THEN CAST( ($STRING_LU_APA['WEIGHT'] * (ITXVIEWRESEP2.CONSUMPTION/100)) * 1000 AS DECIMAL(18, 4))
			END
	END AS QTY,
	CASE 
