                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <select name="no_warna" id="no_warna" onchange="cari_std_cck_warna()" class="js-example-basic-single col-sm-2">
                                                            ...
                                                            <?php
                                                            $q_usergeneric = sqlsrv_query($con_db_lab, "SELECT DISTINCT no_warna FROM db_laborat.tbl_matching WHERE NOT recipe_code = ''");
                                                            while ($row_usergeneric = sqlsrv_fetch_array($q_usergeneric)) {
                                                            ?>
