<?php
    ...
    $cek_approved1      = db2_exec($conn1, "SELECT
                                            ...
                                            WHERE
                                                ...
                                                AND a.FIELDNAME = 'ApprovalDeptUserCode'");
    ...
    if(isset($_POST['submit'])){ 
        ...
        $update_approved1_name   = db2_exec($conn1, "INSERT INTO ADSTORAGE (UNIQUEID,
                                                    ...
                                                    VALUES ('$_GET[UNIQUEID]', 
                                                            ...
                                                            NULL,
                                                            0)");
            header("Location: Approved_hed_user.php?UNIQUEID=$_GET[UNIQUEID]&dept=$_GET[dept]");
                                ...
                                <form action="" method="post">
                                    <p>
                                        <select class="form-control" name="nama" required>
                                            ...
                                            <?php
                                                $q_user_DIT     = db2_exec($conn1, "SELECT
                                                                                        TRIM(CODE) AS CODE,
                                                                                        TRIM(LONGDESCRIPTION) AS LONGDESCRIPTION,
                                                                                        TRIM(SHORTDESCRIPTION) AS SHORTDESCRIPTION,
                                                                                        TRIM(SEARCHDESCRIPTION) AS SEARCHDESCRIPTION 
                                                                                    FROM
                                                                                        USERGENERICGROUP
                                                                                    WHERE
                                                                                        USERGENERICGROUPTYPECODE ='HED'
                                                                                        AND SHORTDESCRIPTION = '$_GET[dept]'");
                                            ?>
