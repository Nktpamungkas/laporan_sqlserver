                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Filter Pencarian Laporan Persediaan Kain Jadi</h5>
                                    </div>
                                    <div class="card-block">
                                        <form action="" method="post">
                                            <div class="row">
                                                <div class="col-sm-12 col-xl-6 m-b-30">
                                                    <h4 class="sub-title">LOT:</h4>
                                                    <input type="input" name="lot" class="form-control">
                                                </div>
                                                <div class="col-sm-12 col-xl-6 m-b-30">
                                                ...
                                                <div class="col-sm-12 col-xl-4 m-b-30">
                                                    <button type="submit" name="cari_tahun" class="btn btn-primary"><i class="icofont icofont-search-alt-1"></i> Cari data</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
