...
<head>
    <title>PRD - UPDATE DATA PROD ORDER</title>
    <meta charset="utf-8">
    ...
    <div class="pcoded-content">
        <div class="pcoded-inner-content">
                                                        ...
                                                        <div class="col-sm-6 col-xl-6 m-b-30">
                                                            ...
                                                            <input type="text" name="prod_order" class="form-control"
                                                                ...
                                                                class="btn btn-primary"><i
                                                                    class="icofont icofont-search-alt-1"></i> Cari
                                                                data</button>
                                                        </div>
                                                    ...
                                                    <div class="dt-responsive table-responsive">
                                                        <table id="basic-btn" class="table compact table-bordered nowrap">
                                                            <thead>
                                                                <tr>
                                                                    <!-- <th>No</th> -->
                                                                    <th>TOTAL PRIMARY QUANTITY</th>
                                                                    <th>TOTAL SECONDARY QUANTITY</th>
                                                                    <th>PRODUCTIONORDER COUNTER CODE</th>
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                //Data Customer dan jumlah untuk setiap customer  
                                                                $query4 = "SELECT
                                                                            ...
                                                                            WHERE
                                                                            CODE ='$prod_order' ";
                                                                $d_prod = db2_exec($conn1, $query4, array('cursor' => DB2_SCROLLABLE));
                                                                while ($rowd = db2_fetch_assoc($d_prod)) {
                                                                    ?>
                                                                    <tr>
                                                                        <td align="center">
                                                                            <form method="post"
                                                                        ...
                                                                        <td align="center">
                                                                            <?php echo $rowd['DEMANDLIST']; ?>
                                                                        </td>
                                                                        <td align="center">
                                                                            <?php echo $rowd['ORDERDATE']; ?>
                                                                        </td>
                                                                    </tr>
                                                                <?php }
                                                                ; ?>
            ...
            <?php
                ...
                if (isset($_POST['submitPrimaryEdit'])) {
                    $editPrimaryCode = $_POST['prod_demand'];
                    $editPrimaryQuantity = $_POST['editPrimaryQuantity'];

                    $query = "UPDATE PRODUCTIONORDER SET TOTALPRIMARYQUANTITY = $editPrimaryQuantity WHERE CODE = '$editPrimaryCode'";
                    $result = db2_exec($conn1, $query);

                    if ($result) {
                        echo "Primary Quantity Berhasil di Update";
                    } else {
                        // mysqli_error(var_dump($result));
                        echo "Gagal Update Primary Quantity.";
                    }
                }

                if (isset($_POST['submitSecondaryEdit'])) {
                    $editSecondaryCode = $_POST['prod_demand'];
                    $editSecondaryQuantity = $_POST['editSecondaryQuantity'];

                    
                    $query = "UPDATE PRODUCTIONORDER SET TOTALSECONDARYQUANTITY = $editSecondaryQuantity WHERE CODE = '$editSecondaryCode'";
                    $result = db2_exec($conn1, $query);

                    if ($result) {
                        echo "Secondary Quantity Berhasil di Update";
                    } else {
                        echo "Gagal Update Secondary Quantity";
                    }
                }
                }
                ?>
