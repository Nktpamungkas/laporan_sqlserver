                                             ...
                                             <div class="row">
                                                 <div class="col-sm-12 col-xl-2 m-b-30">
                                                     ...
                                                     <select name="dept" class="js-example-basic-single col-sm-12" style="width: 100%;" required>
                                                         ...
                                                         <?php
                                                            ...
                                                            ?>
                                                             <option value="<?= $rowdb['DEPARTMENTCODE']; ?>" <?php if ($_POST['dept'] == $rowdb['DEPARTMENTCODE']) {
                                                                                                                    echo "SELECTED";
                                                                                                                } ?>>
                                                                 <?= $rowdb['DEPTNAME']; ?>
                                                             </option>
                                                 ...
                                                 <div class="col-sm-12 col-xl-2 m-b-30">
                                                     ...
                                                     <select name="status" class="js-example-basic-single col-sm-12" style="width: 100%;" required>
                                                         <option value="-" disabled selected>-</option>
                                                         <option value="All" <?php if ($_POST['status'] == 'All') {
                                                                                    echo "SELECTED";
                                                                                } ?>>All</option>
                                                         <option value="Open" <?php if ($_POST['status'] == 'Open') {
                                                                                    echo "SELECTED";
                                                                                } ?>>Open</option>
                                                         <option value="In Progress" <?php if ($_POST['status'] == 'In Progress') {
                                                                                            echo "SELECTED";
                                                                                        } ?>>In Progress</option>
                                                         <option value="Closed" <?php if ($_POST['status'] == 'Closed') {
                                                                                    echo "SELECTED";
                                                                                } ?>>Closed</option>
                                                         <option value="Suspended" <?php if ($_POST['status'] == 'Suspended') {
                                                                                        echo "SELECTED";
                                                                                    } ?>>Suspended</option>
                                                     </select>
                                                 </div>
